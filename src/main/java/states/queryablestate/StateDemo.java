...
public class StateDemo
{
    ...
    public static class StatefulMap extends RichFlatMapFunction<Tuple2<Long, String>, Long>
    {
        ...
        public void open(Configuration conf)
        {
            ...
            descriptor.setQueryable("sum-query"); // to make any state queryable just set it's descriptor as queryable. param is queryable state name which can be different from actual state name
