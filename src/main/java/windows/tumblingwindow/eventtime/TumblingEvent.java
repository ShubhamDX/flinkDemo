    ...
    public static void main(String[] args) throws Exception
    {
        ...
        DataStream<Tuple2<Long, String>> sum = data.map(new MapFunction<String, Tuple2<Long, String>>()
        {
            public Tuple2<Long, String> map(String s)
            {
                ...
                //******* we have to let know flink that which field is timestamp. so we need to override extractAscendingTimestamp method
                ...
                .windowAll(TumblingEventTimeWindows.of(Time.seconds(5))) // since window is on non keyed streams hence used windowAll
