package windows.slidingwindow.processingtime;
...
public class SlidingProcessingTime {
    public static void main(String[] args) throws Exception
    {
        ...
        DataStream<Tuple5<String, String, String, Integer, Integer>> reduced = mapped
                .keyBy(0)
                .window(SlidingProcessingTimeWindows.of(Time.seconds(2), Time.seconds(1))) // window is of 2 seconds and one window will overlap with other by 1 second
                .reduce(new Reduce1());
