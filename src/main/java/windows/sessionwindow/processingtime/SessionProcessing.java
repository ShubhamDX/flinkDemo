package windows.sessionwindow.processingtime;
...
public class SessionProcessing {
    public static void main(String[] args) throws Exception
    {
        ...
        DataStream<Tuple5<String, String, String, Integer, Integer>> reduced = mapped
                .keyBy(0)
                .window(ProcessingTimeSessionWindows.withGap(Time.seconds(1))) // if a gap of 1 sec encountered then all the current windows will be merged and processed
        ...
        //reduced.print();
        reduced.writeAsText("/home/shubham/www");
        // execute program
