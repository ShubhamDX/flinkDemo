...
public class WaterMarkDemo {
    public static void main(String[] args) throws Exception
    {
        ...
        sum.writeAsText("/home/shubham/window");

        // execute program
        env.execute("Window");
    }

    // we can also implement AssignerWithPunctuatedWatermarks which generate watermark based on some property of incoming records. AssignerWithPeriodicWatermarks generate watermarks periodically
    public static class DemoWatermark implements AssignerWithPeriodicWatermarks<Tuple2<Long, String>> // extract timestamp from record and generate watermark from it
    {
