...
public class AverageProfit {
    public static void main(String[] args) throws Exception
    {
        ...
        DataStream<String> data = env.readTextFile("/home/shubham/avg");
        ...
        // June { [Category5,Bat,12,1] Category4,Perfume,10,1}	//rolling operations.reduce
    ...
    // *************************************************************************
    //Input and output of operations.reduce method should be of same type. It basically does rolling aggregations in stream job.
    ...
    public static class Splitter implements MapFunction<String, Tuple5<String, String, String, Integer, Integer>> {
        public Tuple5<String, String, String, Integer, Integer> map(String value)         // 01-06-2018,June,Category5,Bat,12
        {
            ...
            return new Tuple5<String, String, String, Integer, Integer>(words[1], words[2], words[3], Integer.parseInt(words[4]), 1); // last 1 is count so as to calculate average.
